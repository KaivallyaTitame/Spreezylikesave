...
export class PostFormComponent implements OnInit {
  ...
  createRequest(details: FormGroup) {
    this.postFormData.imageFileNames =
      this.postFormDetails.get("imageFileNames")?.value;
    ...
    this.postFormData.businessId =
      this.postFormDetails.get("businessId")?.value;
    this.postFormData.promoBadge = details.value["promoBadge"];
    this.postFormData.termsAndConditions = TextareaUtils.removeBulletPoints(
      details.value["termsAndConditions"]?.trim() || ""
    );
    this.postFormData.stepsToAvailOffer = TextareaUtils.removeBulletPoints(
